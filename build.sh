...
export ARCH=arm64
export KBUILD_BUILD_USER=donjohanliebert
export KBUILD_BUILD_HOST=511Kinderheim
export PATH="$HOME/hzm/prebuilts/clang/host/linux-x86/clang-r522817/bin/:$PATH"
